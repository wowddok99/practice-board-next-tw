    ...
    return (
        <div className="flex flex-col items-center p-24">
            <main className="flex flex-col items-center gap-12 max-w-[50rem] w-[80vw] border rounded shadow-md p-12">
                <h1 className="text-2xl font-bold">게시물 등록</h1>
                <form className="grid grid-cols-2 gap-6">
                    ...
                    <fieldset className="col-span-2 flex flex-col items-start gap-4">
                        <label>제목</label>
                        <input className="w-full text-black" />
                    </fieldset>
                    <fieldset className="col-span-2 row-span-8 flex flex-col items-start gap-4">
                        <label>내용</label>
                        <input className="w-full text-black grow" />
                    </fieldset>
                    <fieldset className="col-span-2 flex flex-col items-start gap-4">
                        <label>주소</label>
                        <div className="flex gap-6">
                            <input className="w-16 text-black" />
                    ...
                    <fieldset className="col-span-2 flex flex-col items-start gap-4 w-full min-w-0">
                        <label>사진 첨부</label>
                    ...
                    <fieldset className="col-span-2 flex flex-col items-start gap-2">
                        <label>메인 설정</label>
